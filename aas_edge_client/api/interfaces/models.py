...
class Interface(models.Model):
    ...
    NetworkMask = models.GenericIPAddressField(protocol='IPv4', null=True, blank=True)
    ...
    LinkLocalIPv6Address = models.GenericIPAddressField(protocol='IPv6', null=True, blank=True)
